...
public class DatabaseGuardService {
    ...
    static {
        ...
        TABLE_DDL.put("oci_create_task", """
            CREATE TABLE IF NOT EXISTS oci_create_task (
                ...
                capacity_probe_mode VARCHAR(16) DEFAULT 'OFF',
        ...
        TABLE_DDL.put("oci_announcement_record", """
        ...
        TABLE_DDL.put("oci_announcement_push_batch", """
    ...
    private void migrateColumns(Connection conn) {
        ...
        addColumnIfMissing(conn, "oci_create_task", "capacity_probe_mode", "VARCHAR(16) DEFAULT 'OFF' AFTER assign_ipv6");
