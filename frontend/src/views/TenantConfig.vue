...
async function loadData(expandAfter?: { groupLevel1?: string; groupLevel2?: string }) {
  if (expandAfter && typeof expandAfter === 'object') {
    setPendingExpandTarget(expandAfter)
  }
